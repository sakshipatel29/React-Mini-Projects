                ...
                <fieldset>
                    ...
                    <div className="prompt-section">
                        ...
                        {prompts.map((prompt, i) => (
                            <div key={prompt.timestamp} className="prompt-group">
                                <div className="prompt-header">
                                    ...
                                    <button type="button" className="delete-btn" onClick={() => handleDelete(i)}>✖</button>
                                </div>
                                <textarea 
                                    id="answer" 
                                    rows={5} 
                        ...
                        <button type="button" className="add-btn" onClick={handleAddPrompt}>+ Add Prompt</button>
                    </div>
                </fieldset>
            </form>
        </div>
